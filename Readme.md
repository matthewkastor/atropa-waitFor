...
```
var waitFor = require('atropa-waitFor').waitFor;
console.log(waitFor);
```

In the browser this module is attached to the global namespace `atropa`, which
 will be created if it does not exist.
 Include `./browser/atropa-waitFor_web.js` in your page and
 `atropa.waitFor` will be available in your page.
...
To run the browser tests open `browser/atropa-waitFor_tests.html` in your
...
If you alter the source in `src/atropa-waitFor.js` please run the
